export default {
    easy: [
        ...
        },
        {
            ...
            summary: `A book whose pages are annotated covers ripped from other books popular in the western world. Selections range from the mundane (a paperback cover of a later run of Stephen King's "It," for example) to the exceptionally rare (a cover from one of the original Gutenberg bibles).<br/><br/>Annotations are dismissive in tone when it comes to the book's content, but universally admiring when describing the cover art.`
        }
    ],
    medium: [
        {
